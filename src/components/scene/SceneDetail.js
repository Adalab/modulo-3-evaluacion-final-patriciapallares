    ...
    <section className='detail__section'>
      <article className='detail__article'>
        ...
        <div className='detail__divINFO'>
          ...
          <p className='detail__card__year'>
            Director:{' '}
            <span className='detail__card__year__bold'>
              {props.scene.director}
            </span>
          </p>
          <p className='detail__card__year'>
            Año:{' '}
            <span className='detail__card__year__bold'>{props.scene.year}</span>{' '}
          </p>
          <a
          ...
          <Link to='/'>
            <button className='detail__card__button'>Volver</button>
          </Link>
        </div>
      </article>
    </section>
